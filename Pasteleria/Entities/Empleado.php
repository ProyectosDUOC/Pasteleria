<?php
    class Empleado{
        ...
        public function Empleado($idEmpleado=0, $rut=0, $nombres=null, $apellidos=null, $fechaNacimiento=0, $telefono=0, $correo=null,$idComuna=null, $activo=0){
        ...
        public function __toString(){
            return 
            "{" . chr(34) . "IdEmpleado" . chr(34) . ":" . chr(34) . $this->getIdEmpleado() . chr(34) 
